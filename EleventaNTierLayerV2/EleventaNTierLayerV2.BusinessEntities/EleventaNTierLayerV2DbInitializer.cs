...
{
    public class EleventaNTierLayerV2DbInitializer : DropCreateDatabaseIfModelChanges<EleventaNTierLayerV2DbContext>
    {
        protected override void Seed(EleventaNTierLayerV2DbContext context)
        {
